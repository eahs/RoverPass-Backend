    ...
    public class ReportTypesController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var reportType = await _context.ReportType
                .FirstOrDefaultAsync(m => m.ReportTypeId == id);
            if (reportType == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("ReportTypeId,Name,IsEnabled")] ReportType reportType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ReportTypeId,Name,IsEnabled")] ReportType reportType)
        {
        ...
        {
            return _context.ReportType.Any(e => e.ReportTypeId == id);
        }
    }
}
