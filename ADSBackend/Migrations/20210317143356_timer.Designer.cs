...
namespace ADSBackend.Migrations
{
    ...
    [Migration("20210317143356_timer")]
    partial class timer
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ADSBackend.Models.ReportStudent", b =>
                {
                    ...
                    b.ToTable("ReportStudent");
                });

            modelBuilder.Entity("ADSBackend.Models.ReportType", b =>
                {
            ...
            modelBuilder.Entity("ADSBackend.Models.Timer", b =>
                {
            ...
            modelBuilder.Entity("ADSBackend.Models.ReportStudent", b =>
                {
                    b.HasOne("ADSBackend.Models.ReportType", "Name")
                        .WithMany()
                        .HasForeignKey("NameId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ADSBackend.Models.Identity.ApplicationUser", "Student")
                        .WithMany()
